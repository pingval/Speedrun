...
- [東方永夜抄 Extra RTA for DSR02](#東方永夜抄-extra-rta-for-dsr02)
  - [簡単な事前説明](#簡単な事前説明)
  - [カテゴリについて(しゃべるネタがないときにでも)](#カテゴリについてしゃべるネタがないときにでも)
  - [道中前半](#道中前半)
...
2023/03の一発勝負パターン参考動画(右上の区間名も参考にしてね): https://www.twitch.tv/videos/1766232017

滅罪寺院傷でラストスペル発動(2ボム消費)。そのためフェニックスの尾でボムを補充するため自殺してます。

----

## 簡単な事前説明
- 東方永夜抄は2004年(※19年前)、同人サークル「上海アリス幻樂団」によって制作された弾幕シューティングゲーム。弾幕とBGMに定評のある「東方Project」シリーズの第8弾にあたる。
- 自機は、「マリス砲」というテクニックの使える詠唱組を選択する。自機の選択と同時にタイマー開始。

## カテゴリについて(しゃべるネタがないときにでも)
- カテゴリはExtra。以下が特徴。
...
- マリス砲について(道中前半か後半の適当なときにお願いします)
  - 普通にショットボタンを押すと「魔理沙のショット」が出る。低速移動ボタンを押すと操作キャラがアリスに切り替わり、ショットボタンを押すと「アリスのレーザー」が出る。
   - アリスのレーザーはショットボタンを離しても少しの間持続するため、低速移動ボタンをタイミングよく連打すると「魔理沙のショット」と「アリスのレーザー」が同時発生し、火力が増加する。このテクニックを「マリス砲」と呼ぶ。
  - マリス砲がその真価を発揮するのは、貫通性能を持つレーザーが多数の使い魔に当たる状況。使い魔に与えたダメージはその1/2が本体のボスに還元されるため、すさまじい速度でボスの体力が削られる。
    - 具体的には、終盤の「フジヤマヴォルケイノ」と「パゼストバイフェニックス」。見せ場でもある。

## 中ボス: <ruby>上白沢<rp>(</rp><rt>かみしらさわ</rt><rp>)</rp></ruby><ruby>慧音<rp>(</rp><rt>けいね</rt><rp>)</rp></ruby>
- 会話中にx軸を画面下のEnemyマーカーの「y」の右上に合わせておく

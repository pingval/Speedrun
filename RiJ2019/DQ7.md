...
- ***プレイヤー紹介(気に入らなかったら好きに変えてね！！)***
  ...
  - ***yagamuu***
    - ***DQ1,2とかアークザラッドシリーズとかローグライク(トルネコ・シレン・ドラゴンファング)をRTA。RTA in Japanでは、アークザラッド・トルネコの大冒険・美味しんぼ・モンスターファーム2を走った。一昨年のアンキモタイマントーナメントでは準優勝。そして昨年の内藤九段将棋秘伝トーナメントでは優勝し内藤九段位を獲得したのは記憶に新しいところ。***
    - ***自己ベは2:30。***
    - アークザラッド2を改竄RTAした。
  - アジーン(解説)

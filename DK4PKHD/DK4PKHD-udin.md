...
- [大航海時代Ⅳ with パワーアップキット HD Version ウッディーン編RTA解説資料](#大航海時代ⅳ-with-パワーアップキット-hd-version-ウッディーン編rta解説資料)
  ...
  - [戦略概要](#戦略概要)
    ...
    - [必要最小限の敵勢力を解散させつつ、覇者の証を一気に集める。](#必要最小限の敵勢力を解散させつつ覇者の証を一気に集める)
    - [運要素](#運要素)
...
- 攻略チャート
  - [ping値](https://github.com/pingval/Speedrun/blob/master/DK4PKHD/dk4pk-udin-chart.txt)
  - [ドラゴソ?](https://drgs.app/chart-of-uncharted-waters/Udin.html)
...
1. 必要最小限の敵勢力を解散させつつ、覇者の証を一気に集める。

### 自動航路を繋ぎながら航海士(仲間)を集める

主人公はアンサガ(RTA in Japan Winter 2022 アーミック編よろしく！)と同じで7人。ウッディーンはその中でも序盤から戦力が充実しており初心者向け。RTA的にも進めやすい部類に入る。
...
航海が長ければ長いほど獲得経験値が増える。1年半の航海でレベル130前後まで上がる(レベルmaxは200)。
...
- 長期航海レベリング中のアクシデント
  - 「病気」になると疲労度がガンガン上昇し、疲労100に達して水夫が0人になりゲームーオーバー。
  - 「竜巻」の当たりどころが悪いと水夫が0人になりゲームオーバー。
...
- 「覇者の証」の位置
  - 覇者の証の位置はそれぞれの海域で8パターン。これはゲーム開始時に決定されるためセーブロードしても変更できない。
  - 自動航路から大きく外れたパターンを引いたらその分ロス。特に**東南アジアの東の方**を引いたら辛い。
- 古の地図
  - 街に入るとたまに古の地図の切れ端を貰えるが、これが4枚揃うと古の地図が完成する。古の地図の示す場所で探索するとバケモノとの戦闘になり、撃破するとレアなアイテムを貰える。
  - が、そこは覇者の証の位置と同じ。バケモノを撃破しないと覇者の証を取れない！
  - 覇者の証を回収するには、砲台の多い船を揃えてバケモノを撃破する必要が出てくる。
  - 滅多には起きないが……クソゲー！

8/13までにるぱんさんのルートに沿うよう修正。

----

カームカット導入前後のPC Any%戦略の変化を「<strike>打ち消し線</strike>→変化した内容」という形で表しています。
元: [AGDQ2021向け解説テキスト](./FF7PC-Any-AGDQ2021.md)
...
- <strike>行きの道でフェニックス尾(売値150G)を回収*しない*。</strike>→セブンスヘブンスキップしないことで寄り道せずとも充分な手榴弾を買えるようになったため、ここらへんはどーでもよくなった。

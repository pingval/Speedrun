...
- BOSS: アルテマウェポン(HP: ?)
  ...
  - アルテマウェポンのHPは1000,000だが、本来戦うはずのミディールで戦わなかったせいか、HPが変なことになっている。
  - ポーションでHPを100回復してやるとHPが100になり、最終決戦場であるコスモキャニオン上空へワープする。
- ジュノンで神羅潜水艦を回収する。
  - 戦闘: 神羅潜水兵(HP: 1500)*2
  - 選択肢は全て1番目でOK。
- コスモキャニオン上空にいるアルテマウェポンに接触する
- BOSS: アルテマウェポン(HP: 100)
...
- ボス: エメラルドウェポン(HP: 1,000,000) + 目*4(HP: 25,000)
  - 本体
    - 吸収: 冷気・水
    - 無効: 土・毒
    - 半減: 重力
...
- ボス: ルビーウェポン(HP: 800,000) + 触手(HP: 40,000)*2
  - 本体
    - 吸収: 炎・冷気・雷・土
    - 無効: 毒・重力・水
  - 触手

...
- バレットスキップ(Barret Skip)
  - [https://www.youtube.com/watch?v=Lbf6NGBdQdU](https://www.youtube.com/watch?v=Lbf6NGBdQdU)
...
- 右下の武器屋で**手榴弾**を買う
  - 今後デバッグルームに入るまで、攻撃手段は**手榴弾**がメイン。140前後の大ダメージ・確定命中・後列からでも与ダメ減らない・モーション短い・アイテムなので誰でも使える。ただし1個につき80Gで、数に限りがある。

...
断トツの最速記録保持者ArelさんはTwitter上に観測されないため個別に知らせようとしたものの、DiscordアカウントにDMを送ることができなかった(名前を変更したことの影響だったらしい)ためspeedrun.comのメッセージ機能を使った。しかし彼が最後にspeedrun.comを訪れたのは一月前らしく、募集期間内にコンタクトを取るのは絶望的かなあといったところ。
...
四字熟語活動(四字熟語FlashのRTA環境を整える行為の総称)ことヨジカツ！の一環としてAutoSplit設定を更新する。
...
四字熟語FlashのVAS(Video Auto Splitter)を作る。のちにAutoSplitがバージョンアップで便利になったことにより、これは使わなくなった。
...
Arelさんが四字熟語Flash最速記録を更新。音信不通だったArelさんとこのときコンタクトが取れる。
...
紆余曲折あったが、RiJ2020の解説は結局安定のアジーンさんにお願いする。名古屋RTAオフお楽しみの最中であった。
...
Flashお別れRTA会スケジュール発表。マラソンイベントで鳳寿司を担当するとか初めてなんだけど。
...
Ruffleで四字熟語Flashを再生するとパネルの文字色が緑色になるバグを報告したらものの二日で修正される。しゅごい。
...
ダメ元でRiJ2020の英語リストリーム解説を募ると、海外のサガ勢であるマイケル氏が立候補してくれる。NANI!?
...
Flashお別れRTA会で三字熟語Flashと四字熟語Flash(わいなぎさんとの並走。負け)を走る。用意した[台本](EndoFFlash.md)ガン見でなんとか乗り切る。参加した感想はこれ！
...
RiJ2020に先立ってOBS.Ninjaが使用されており、走者も運営も四苦八苦していた。自分の映像が一瞬荒ぶっていたのをしっかり反省していればRiJ2020で映像が固まることはなかったかもなあ……。
...
無言で走っていたらタイムが大きく縮み出す。走りながら**熟語を口に出していたことがボトルネック**となっていた可能性が高い。あくえりさんもマイクありなのに無言でやってたしそういうことなんだろうな。
...
前日にRTA攻略ページ(玄人向け)とRTAGamersの紹介記事(素人向け)のどっちをツイートしてもらうか走者間で軽く相談して、キチっぷりをアッピールしようということで前者を紹介してもらうことにした。このトゥイートの後半の文面は自分が作成しました。
